...
#+BEGIN_SRC emacs-lisp
  ...
  ^Programs^        ^Bookmarks^
  ^^^^-------------------------
  _b_: brave        _u_: My Unito
  _t_: Telegram     _m_: Moodle
  ^ ^               _g_: githubg
  "
      ("b" (lambda () (interactive) (start-process "brave" nil "brave-browser")) nil)
      ("t" (lambda () (interactive) (start-process "telegram" nil "telegram-desktop")) nil)
      ("u" (browse-url "https://my.unito.it/") nil)
      ("m" (browse-url "https://math.i-learn.unito.it/") nil)
      ("g" (browse-url "https://github.com/") nil)
  ...
  _n_: down
  "
      ("p" (lambda () (interactive) (hydra-volume/change-volume 'up   "5")) nil)
      ("n" (lambda () (interactive) (hydra-volume/change-volume 'down "5")) nil)
      ("q" nil nil))
  ...
  _n_: down
  "
      ("p" (lambda () (interactive) (hydra-brightness/change-brightness 'up "5")) nil)
      ("n" (lambda () (interactive) (hydra-brightness/change-brightness 'down "5")) nil)
      ("q" nil nil))
